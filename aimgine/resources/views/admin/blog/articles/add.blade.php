                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">New article </span>
                                        </div>

                                    </div>
                                    <div class="portlet-body form">
                                        <form id="addBlogArticle" role="form" method="POST" action="{{URL::to('admin/blog/articles')}}" enctype="multipart/form-data" accept-charset="UTF-8">
                                            <div class="form-body">

                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Article position</label>
                                                ...
                                                <div class="form-group">
                                                    <label>Meta</label>
                                                    <textarea class="form-control" rows="3" name="meta">{{ old('text') }}</textarea>
                                                </div>
                                                <div class="form-group">

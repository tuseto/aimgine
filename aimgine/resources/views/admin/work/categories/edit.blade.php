                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <form role="form" method="POST" action="{{URL::to('admin/work/categories/'.$category->id)}}" enctype="multipart/form-data" accept-charset="UTF-8">
                                            {!! method_field('PUT') !!}
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Slider position</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="position" id="exampleInputPassword1" placeholder="Position" value="{{$category->position}}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Name</label>

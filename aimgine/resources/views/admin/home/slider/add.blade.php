                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <form role="form" method="POST" action="{{URL::to('admin/home/slider')}}" enctype="multipart/form-data" accept-charset="UTF-8">
                                            <div class="form-body">

                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">Slider position</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="position" value="{{ old('position') }}" id="exampleInputPassword1" placeholder="Slider position number">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Text</label>

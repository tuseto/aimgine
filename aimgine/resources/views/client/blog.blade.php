		...
		<div class="container">
				...
				<section class="in_section blog-page">
						...
						<div class="filtering-links text-center">
                                ...
                                @endforeach
                                <?php $articleName = str_replace(' ','-',$article->name); ?>

                                	<a href="{{URL::to('blog/'.$catName.'/'.$articleName.'/'.$article->id)}}"><strong>more</strong></a></p>
								<span class="cuted-span white"></span><!--arrow-->
								</div><!-- blog box -->
                                @endforeach

...
<section>
		...
		<div class="container">
				...
				<h3 class="bottom_line">OUR CLIENTS</h3>
		...
		<div class="container">
				...
				<div class="row fix_mobile">
						...
						<div class="span4 text-center client-box">
							<div class="img-holder">
								<span><img src="{{URL::to('content/img/ourclients/'.$client->logo)}}" alt=" "></span>
							<a href="#" class="hover"><span>View projects</span></a>
							</div><!-- img holder -->
							<h4><a href="#">{{$client->name}}</a></h4>
							<p>Short description of the business of the client.</p>
						</div><!--span 4 column box-->
                        @endforeach
